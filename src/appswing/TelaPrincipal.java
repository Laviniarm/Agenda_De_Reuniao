	...
	private void initialize() {
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		        ...
		        if (idText.isEmpty() || data.isEmpty() || assunto.isEmpty() || nomesPessoas.isEmpty()) {
		            label.setText("Preencha os campos obrigatórios");
		            return;
		        }
				try {
					int id = Integer.parseInt(idText);
					Fachada.criarReuniao(id, data, assunto, nomesPessoas);
					listagemReunioes();
					nomesPessoas.clear();
				} catch (Exception ex) {
		...
		textField.setBounds(291, 26, 86, 20);
		...
		textField_1.setBounds(391, 26, 85, 20);
		frame.getContentPane().add(textField_1);
		
		label_2 = new JLabel("Data");
		label_2.setBounds(391, 11, 46, 14);
